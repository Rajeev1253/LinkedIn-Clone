...
import { deleteRequest, updateRequest } from '../features/connection/connectionAction';
...
const Request = (props) => {
    ...
    const handleAccept = async () => {
        ...
        console.log('senderId: ', senderId.props.connectionBy);
        const res = dispatch(updateRequest({ senderId, token }))
        console.log(res)
    }
